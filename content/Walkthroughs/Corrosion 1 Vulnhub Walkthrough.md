...
**Browse to *[http://192.168.5.119/tasks/tasks\_todo.txt](http://192.168.5.119/tasks/tasks_todo.txt?ref=rootandbeer.com)* -**
...
**Find randy's SSH password in the file *my\_password.txt*:**
